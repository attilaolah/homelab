...
in {
  ...
  cert-manager.helm = ["https://charts.jetstack.io" "1.17.2"];
  cilium.helm = ["https://helm.cilium.io" "1.17.3"];
  ...
  external-secrets.helm = ["https://charts.external-secrets.io" "0.16.1"];
  flux-operator.helm = ["oci://ghcr.io/controlplaneio-fluxcd/charts" "0.19.0"];
  ...
  homepage.docker = ["ghcr.io/gethomepage/homepage" "1.1.1" vp];
  ...
  k0s.docker = ["attilaolah/k0s" "1.32.3.0"];
  k0s.github-releases = ["k0sproject/k0s" "1.32.3+k0s.0" vp];
  keycloak.helm = ["oci://registry-1.docker.io/bitnamicharts" "24.6.1"];
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "70.10.0"];
  kubelet-csr-approver.helm = ["https://postfinance.github.io/kubelet-csr-approver" "1.2.7"];
  kubernetes.github-releases = ["kubernetes/kubernetes" "1.32.4" vp];
  local-path-provisioner.github-releases = ["rancher/local-path-provisioner" "0.0.31" vp];
  loki.helm = ["https://grafana.github.io/helm-charts" "6.29.0"];
