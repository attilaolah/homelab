...
in {
  ...
  jaeger-collector.docker = ["jaegertracing/jaeger-collector" "1.67.0"];
  jaeger-query.docker = ["jaegertracing/jaeger-query" "1.67.0"];
  ...
  keycloak.helm = ["oci://registry-1.docker.io/bitnamicharts" "24.5.2"];
