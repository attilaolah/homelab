...
in {
  ...
  external-secrets.helm = ["https://charts.external-secrets.io" "0.14.4"];
  ...
  homepage.docker = ["ghcr.io/gethomepage/homepage" "1.0.3" vp];
  ...
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "70.0.2"];
