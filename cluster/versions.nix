...
in {
  ...
  flux-operator.helm = ["oci://ghcr.io/controlplaneio-fluxcd/charts" "0.32.0"];
  flux.github-releases = ["fluxcd/flux2" "2.7.2"];
  ...
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "77.14.0"];
  ...
  talos.github-releases = ["siderolabs/talos" "1.11.3" vp];
