...
in {
  ...
  keycloak.helm = ["oci://registry-1.docker.io/bitnamicharts" "24.7.1"];
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "72.6.2"];
  kubelet-csr-approver.helm = ["https://postfinance.github.io/kubelet-csr-approver" "1.2.8"];
  ...
  loki.helm = ["https://grafana.github.io/helm-charts" "6.30.0"];
