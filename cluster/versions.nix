...
in {
  ...
  flux-operator.helm = ["oci://ghcr.io/controlplaneio-fluxcd/charts" "0.29.0"];
  ...
  ingress-nginx.helm = ["https://kubernetes.github.io/ingress-nginx" "4.13.2"];
  ...
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "77.11.1"];
  ...
  loki.helm = ["https://grafana.github.io/helm-charts" "6.40.0"];
  ...
  node-feature-discovery.helm = ["https://kubernetes-sigs.github.io/node-feature-discovery/charts" "0.17.4"];
