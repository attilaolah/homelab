...
in {
  ...
  external-secrets.helm = ["https://charts.external-secrets.io" "0.19.0"];
  flux-operator.helm = ["oci://ghcr.io/controlplaneio-fluxcd/charts" "0.26.0"];
  ...
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "75.18.1"];
