...
in {
  ...
  cilium.helm = ["https://helm.cilium.io" "1.18.0"];
  cloudnative-pg.helm = ["https://cloudnative-pg.io/charts" "0.25.0"];
  descheduler.docker = ["registry.k8s.io/descheduler/descheduler" "0.33.0"];
  descheduler.helm = ["https://kubernetes-sigs.github.io/descheduler" "0.33.0"];
  external-secrets.helm = ["https://charts.external-secrets.io" "0.19.1"];
  ...
  goldilocks.helm = ["https://charts.fairwinds.com/stable" "9.2.0"];
  homepage.docker = ["ghcr.io/gethomepage/homepage" "1.4.4" vp];
  ...
  keycloak.helm = ["oci://registry-1.docker.io/bitnamicharts" "25.0.0"];
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "76.2.0"];
  ...
  loki.helm = ["https://grafana.github.io/helm-charts" "6.34.0"];
