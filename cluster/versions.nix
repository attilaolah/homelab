...
in {
  ...
  keycloak.helm = ["oci://registry-1.docker.io/bitnamicharts" "24.6.4"];
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "72.0.1"];
  ...
  talos.github-releases = ["siderolabs/talos" "1.10.1" vp];
