...
in {
  ...
  cilium.helm = ["https://helm.cilium.io" "1.18.5"];
  ...
  flux-operator.helm = ["oci://ghcr.io/controlplaneio-fluxcd/charts" "0.38.1"];
  flux.github-releases = ["fluxcd/flux2" "2.7.5"];
  goldilocks.docker = ["us-docker.pkg.dev/fairwinds-ops/oss/goldilocks" "4.14.8" vp];
  goldilocks.helm = ["https://charts.fairwinds.com/stable" "10.2.0"];
  headlamp.docker = ["ghcr.io/headlamp-k8s/headlamp" "0.38.0" vp];
  headlamp.helm = ["https://kubernetes-sigs.github.io/headlamp" "0.38.0"];
  homepage.docker = ["ghcr.io/gethomepage/homepage" "1.8.0" vp];
  ...
  k0s.github-releases = ["k0sproject/k0s" "1.34.2+k0s.0" vp];
  ...
  local-path-provisioner.github-releases = ["rancher/local-path-provisioner" "0.0.35" vp];
  ...
  redis.docker = ["redis" "8.4.0"];
  reloader.helm = ["oci://ghcr.io/stakater/charts" "2.2.7"];
  spegel.helm = ["oci://ghcr.io/spegel-org/helm-charts" "0.5.1"];
  talos.github-releases = ["siderolabs/talos" "1.12.0" vp];
  vector.helm = ["https://helm.vector.dev" "0.48.0"];
