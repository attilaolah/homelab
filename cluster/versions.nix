...
in {
  ...
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "69.2.4"];
  ...
  loki.helm = ["https://grafana.github.io/helm-charts" "6.26.0"];
  ...
  zfs-localpv.helm = ["https://openebs.github.io/zfs-localpv" "2.7.0"];
