...
in {
  ...
  external-secrets.helm = ["https://charts.external-secrets.io" "0.16.2"];
  flux-operator.helm = ["oci://ghcr.io/controlplaneio-fluxcd/charts" "0.20.0"];
  ...
  jaeger-collector.docker = ["jaegertracing/jaeger-collector" "1.69.0"];
  ...
  keycloak.helm = ["oci://registry-1.docker.io/bitnamicharts" "24.6.6"];
  kube-prometheus-stack.helm = ["https://prometheus-community.github.io/helm-charts" "72.3.0"];
