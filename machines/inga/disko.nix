...
# [placeholders]
# mainDisk = "/dev/disk/by-id/ata-SanDisk_SDSA6MM-016G-1006_143089409391" 
# ---
...
# CHANGING this configuration requires wiping and reinstalling the machine
{
  ...
  disko.devices = {
    disk = {
      "main" = {
        name = "main-22264aa0f9724a909816162f8d6bfbf6";
        device = "/dev/disk/by-id/ata-SanDisk_SDSA6MM-016G-1006_143089409391";
        type = "disk";
        content = {
          type = "gpt";
          partitions = {
