...
# [placeholders]
# mainDisk = "/dev/disk/by-id/ata-SanDisk_SDSA6DM-016G-1006_142002407505" 
# ---
...
# CHANGING this configuration requires wiping and reinstalling the machine
{
  ...
  disko.devices = {
    disk = {
      "main" = {
        name = "main-cd88ed0787ed42b48aeca34ccee17887";
        device = "/dev/disk/by-id/ata-SanDisk_SDSA6DM-016G-1006_142002407505";
        type = "disk";
        content = {
          type = "gpt";
          partitions = {
