...
# [placeholders]
# mainDisk = "/dev/disk/by-id/ata-XrayDisk_128GB_AA000000000000000232" 
# ---
...
# CHANGING this configuration requires wiping and reinstalling the machine
{
  ...
  disko.devices = {
    disk = {
      "main" = {
        name = "main-b5f5b3cb41534755824e8417780c4e94";
        device = "/dev/disk/by-id/ata-XrayDisk_128GB_AA000000000000000232";
        type = "disk";
        content = {
          type = "gpt";
          partitions = {
